      ...
      <Container>
        <Row>
          <div className={styles.termsofuse}>
            ...
            <ul>
              <li className='font15 fw500 colortextgrey font-f'>Customer expressly understands and agree that their use of the services is at their sole risk and that the services are provided “as is” and “as available.” In particular, the company, its subsidiaries, and affiliates, and its licensors do not represent or warrant to customers that:.</li>
              <li className='font15 fw500 colortextgrey font-f'>Customer’s use of the services will meet their requirements,</li>
              <li className='font15 fw500 colortextgrey font-f'>Customer’s use of the services will be uninterrupted, timely, secure or free from error,</li>
              <li className='font15 fw500 colortextgrey font-f'>Any information obtained by customers as a result of their use of the services will be accurate or reliable</li>
            </ul>
