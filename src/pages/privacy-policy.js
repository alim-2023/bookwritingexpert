            ...
            <Container>
                <Row>
                    <div className={styles.termsofuse}>
                        ...
                        <p className='font15 fw500 colortextgrey font-f'>
                        ...
                        <p className='font15 fw500 colortextgrey font-f'>Our Privacy Policy covers any visitor to our Site(s). This policy applies to both online and offline collection, storage, processing, and transfer of Personal Information.</p>


                        <h3 className='font-f'>Definitions</h3>


                        <p className='font15 fw500 colortextgrey font-f'>As used in this Privacy Policy, the following terms have the following meanings:</p>


                        <ul>
                            <li className='font15 fw500 colortextgrey font-f'>“Financial Information” means specific Personal Information of a financial nature such as your
                                credit card number.
                            </li><li className='font15 fw500 colortextgrey font-f'>“Information” means any Information collected and includes: “Personal Information”, “Financial
                                Information”, “Web Analytical Information” or any other Information collected from you through
                                our Site(s).
                            </li>

                            <li className='font15 fw500 colortextgrey font-f'>“Marketing Information” means your Web Analytical Information and your Personal Information such
                            ...
                            <li className='font15 fw500 colortextgrey font-f'>“Personal Information” means Information that may be used, alone or in combination, to identify
                                a specific individual and includes Financial Information.
                            </li>
                            <li className='font15 fw500 colortextgrey font-f'>“Site” or “Sites” means the Organization’s website located at www.bookwritingcube.com as any
                            ...
                            <li className='font15 fw500 colortextgrey font-f'>“Social Network”, means various Internet communication technologies provided on Sites that
                            ...
                            <li className='font15 fw500 colortextgrey font-f'>“Social Network Content” (or “SNC”) means the user-generated content you consent to share via a
                            ...
                            <li className='font15 fw500 colortextgrey font-f'>“Organization”, “we”, “us”, and “our” refer to the Bookwriting Cube.
                            </li>
                            <li className='font15 fw500 colortextgrey font-f'>“Unrelated Entities” means third parties that are not Educational Partners and who are not
                                providing services to Bookwriting Cube. as Business Associates.
                            </li>
                            <li className='font15 fw500 colortextgrey font-f'>“Web Analytical Information” means internet generated Information we collect when you visit our
                        ...
                        <p className='font15 fw500 colortextgrey font-f'>Each time you visit one of our Sites, Web Analytical Information is automatically gathered. In general, this Information does not identify you personally. Examples of Web Analytical Information include, but are not limited to:.</p>


                        <ul>
                            <li className='font15 fw500 colortextgrey font-f'>IP address</li>
                            <li className='font15 fw500 colortextgrey font-f'>Collection Date</li>
                            <li className='font15 fw500 colortextgrey font-f'>Publisher Name</li>
                            <li className='font15 fw500 colortextgrey font-f'>Connection Speed</li>
                            <li className='font15 fw500 colortextgrey font-f'>Day of Week Time of Day (hour)</li>
                            <li className='font15 fw500 colortextgrey font-f'>Language settings</li>
                            <li className='font15 fw500 colortextgrey font-f'>Country, State, DMA, City (relating to IP address, if available)</li>
                            <li className='font15 fw500 colortextgrey font-f'>Domain (.com, .net, .mil, .org, .edu, etc.)</li>
                        </ul>
                        ...
                        <p className='font15 fw500 colortextgrey font-f'>The Organization recognizes that by choosing to provide us with your Personal Information, you are demonstrating your trust in us and we take that trust seriously. We will not sell, rent or lease your Personal Information to others. We may collect, use and disclose Personal Information for the following purposes:</p>
                        <ul>
                            <li className='font15 fw500 colortextgrey font-f'>to provide requested products and services</li>
                            <li className='font15 fw500 colortextgrey font-f'>to respond to your inquiries</li>
                            <li className='font15 fw500 colortextgrey font-f'>to administer promotions to which you have indicated an interest</li>
                            <li className='font15 fw500 colortextgrey font-f'>for our internal marketing purposes, which includes, but is not limited to, sending you material
                                about products, services, updates, etc. that we think may be of interest to you</li>
                            <li className='font15 fw500 colortextgrey font-f'>for fostering communication and collaboration among members of the Organization community
                                through Social Networks</li>
                            <li className='font15 fw500 colortextgrey font-f'>for sharing with our Partners who may contact you with respect to their services;</li>
                            <li className='font15 fw500 colortextgrey font-f'>for sharing with our Partners or Business Associates who are performing services on our behalf
                            </li>
                            <li className='font15 fw500 colortextgrey font-f'>to analyze how Sites and services are being accessed and used;</li>
                            <li className='font15 fw500 colortextgrey font-f'>to improve Site and service performance and delivery</li>
                            <li className='font15 fw500 colortextgrey font-f'>to analyze academic and learning outcomes and preferences</li>
                            <li className='font15 fw500 colortextgrey font-f'>to analyze risk and business results</li>
                            <li className='font15 fw500 colortextgrey font-f'>to obtain payment for services that we provide to you</li>
                            <li className="last">to maintain business records for reasonable periods</li>
                        </ul>

                        <p className='font15 fw500 colortextgrey font-f'>In connection with the uses set forth above, we may use an automatic telephone dialing system, artificial or prerecorded voice messages, or text messages to provide you with various communications. Further, when you provide us with a cellular, wireless, or mobile telephone number as your contact number, you agree that you are providing us with your express consent to receive calls using an automated dialing system, prerecorded voice messages or text messages related to your enrollment. If you do not wish to receive these updates on your cellular or mobile phone, please provide us with a LAN-based telephone number.</p>


                        <h3 className='font-f'>Financial Information</h3>

                        <p className='font15 fw500 colortextgrey font-f'>Your Financial Information will be used to provide requested products and services, to analyze operational and business results, to analyze risk, and for concluding your registration or other transaction you have initiated with us. It will not be sold, rented, or otherwise transferred to an Educational Partner, Business Associate or Unrelated Entity outside of this purpose, except in the case of a reorganization, merger or acquisition of our shares or assets.</p>

                        <p className='font15 fw500 colortextgrey font-f'>We use Secure Socket Layer (SSL) 128-bit encryption to protect your credit card details submitted to us over the Internet. No one can view your credit card information, not even our staff members.</p>

                        <h3 className='font-f'>Opt-Out</h3>

                        <p className='font15 fw500 colortextgrey font-f'>You may opt-out of our collection, use and disclosure of your Personal Information at any time, subject to contractual, academic, legal or technical restrictions and reasonable notice. Note that if you opt-out of certain uses of your Personal Information, we may no longer be able to provide certain products or services. You may not be permitted to opt-out to the certain necessary collection, uses, and disclosures, for example, but not limited to, educational announcements, maintaining reasonable academic, business and transaction records and disclosures to government entities as required for us to comply with applicable laws.</p>


                        <p className='font15 fw500 colortextgrey font-f'>You can choose to no longer receive marketing communications from us and you may express your choice where indicated on the applicable email or other communication. Please note, however, that such a request will only remove you from our list and the list of any Business Associate performing services on our behalf. We are not responsible for the use any other party may make of the Information once it has been transferred in accordance with this Policy and you will need to contact such entity to have your Information removed from their database.</p>


                        <p className='font15 fw500 colortextgrey font-f'>You may change various user settings related to sharing your Personal Information contained in any user profile you set up as part of Social Network activities furnished by us, subject to contractual, academic, legal or technical restrictions and reasonable notice. Note that your withdrawal from Social Network activities might prevent us from providing you with certain products or services.</p>
                        ...
                        <p className='font15 fw500 colortextgrey font-f'>If you want access to or wish to update any of your Personal Information or have any questions about our privacy practices, please contact at:</p>
