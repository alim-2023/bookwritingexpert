...
<div>
                        ...
                        <p className='font15  textcolor t-center font-f'>Use Social Media to Market your Brand!</p>
...
<div className='mt-5'>
                        ...
                        <p className='font15  textcolor t-center font-f'>Increase your Listings and Subscriptions on Email Today!</p>
                        <Link className={styles.lets} href='#'>LET'S DISCUSS</Link>
                    </div>
...
<Col md={3}>
    ...
    <div className='mt-5'>
        ...
        <p className='font15  textcolor t-center font-f'>Our Proven Game-Plan For SEO Success</p>
           <Link className={styles.lets} href='#'>LET'S  DISCUSS </Link> 
