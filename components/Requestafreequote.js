   ...
   <>
    <div className={styles.freequote}>
       ...
       <Container>
        ...
        <h2 className="fw900 font48 colorexpertgrey font-f t-center">Request A Free Quote</h2>
        ...
        <Col md={4}>    <h3 className="fw900 font48 colorexpertgrey font-f t-left">Email Us</h3></Col>
        <Col md={4}> 
