       ...
       <Container>
        ...
        <Col md={4}> 
            ...
            <div>
                ...
                <Link className={styles.emailhref} href="mailto:support@bookwritingexperts.com">  support@bookwritingexperts.com </Link> </p>
            </div>
        ...
        <div>
                ...
                <Link className={styles.emailhref} href="tel:213-289-3888"> 213-289-3888 </Link> </p>
            </div>
